...
# This project demonstrates complete automation of infrastructure provisioning and CI/CD deployment pipeline using Terraform, Jenkins, Docker, and Kubernetes on AWS. It provisions three EC2 Ubuntu servers (1 
 master, 2 slaves), installs Kubernetes, deploys a sample web app from GitHub, builds a Docker image, pushes it to Docker Hub, and deploys it to Kubernetes.
...
# Project Output
  ...
  Docker image pushed: ajithpethanan/demo1

  Application deployed to Kubernetes on port 30008

  Web page renders index.html with background image and message.
